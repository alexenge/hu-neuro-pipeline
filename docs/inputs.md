...
The pipeline will then compute by-participant condition averages (a.k.a. evokeds) for all main effects and interaction effects (if applicable).
...
### **`interactions` (optional, default: `'all'`)**
